    ...
    <div class="container-xl">
        <div class="row row-cards mt-4">
                        ...
                        <div id="carousel-captions" class="carousel slide" data-bs-ride="carousel">
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img class="d-block w-100" alt="" src="img/{{ $first->photo }}">
            ...
            <div class="col-md-6">
                <div class="row">
                    <div class="col-md-6">
                        <img src="img/{{ $first->photo }}" class="rounded float-right">
                    </div>
                    <div class="col-md-6">
                        <img src="img/{{ $first->photo }}" class="rounded float-right">
                    </div>
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col">
                                <div class="col">
                                    ...
                                    <div class="text-muted">
                                        Dapat ditukar jika tidak sesuai
                                    </div>
                                </div>
                            </div>
                        </div>
